...
class CarteiraControllerTest {
    ...
    void listarLancamentosAutenticadoRetorna200() throws Exception {
        when(service.listarLancamentos(anyLong(), any())).thenReturn(new PageImpl<>(List.of(mockLancamento())));
    ...
    private Lancamento mockLancamento() {
        ...
        return new Lancamento(42L, acao, corretora, new BigDecimal("100"), new BigDecimal("32.50"),
